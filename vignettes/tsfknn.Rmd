...
as the square root of the number of examples. The lags are selected as 1:*f*, where *f* is the number of periods of the time series, for example, 4 for quarterly data.
